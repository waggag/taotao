...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://localhost:8080"><img src="/images/shop-logo.jpg" width="270" height="60" alt="商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="王港"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="13283860024"/>
		<input type="hidden" name="orderShipping.receiverState" value="河南"/>
		<input type="hidden" name="orderShipping.receiverCity" value="郑州"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="新郑市"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="郑州工业应用技术学院"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">王港</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">132****0024</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">河南 郑州 新郑市</div>
						<div class="adr-m" limit="30">郑州工业应用技术学院</div>
...
<div class="step-tit">
	<h3>送货清单</h3>
	<div class="extra-r">
					<a href="http://localhost:8088/cart/cart.html" id="cartRetureUrl" class="return-edit ftx-05">返回修改购物车</a>
			</div>
</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：商城</h4>		         
			...
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">快递<i
						class='qmark-icon qmark-tip'
						data-tips='由公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
