...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld">
			<a href="http://localhost:8080" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b>
				<img src="/images/shop-logo.jpg" width="270" height="60" alt="网上商城"></a>
		</div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld">
					<s></s><a href="http://localhost:8087/user/login"
						clstag="homepage|keycount|home2012|04a">我的商城</a><b></b>
				</dt>
				<dd>
			...
			<dl>
				<dt class="ld">
					<s></s><span class="shopping"><span id="shopping-amount"></span></span><a
						href="http://localhost:8090/order/order-cart.html" id="settleup-url">去购物车结算</a> <b></b>
				</dt>
			</dl>
		</div>
		<!--settleup end-->
