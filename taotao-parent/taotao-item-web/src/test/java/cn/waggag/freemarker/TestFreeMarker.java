...
public class TestFreeMarker {
	...
	public void testFreemarker() throws Exception {
		...
		configuration.setDirectoryForTemplateLoading(
				new File("D:/WorkSpace/IntelliJ IDEA/商城项目/taotao-parent/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
		//4.设置模板的字符集，一般utf-8
		...
		data.put("vall","123456");
		//7.创建一个Writer对象，指定输出文件的路径及文件名。
		Writer out = new FileWriter(new File("D:/html/student.html"));
